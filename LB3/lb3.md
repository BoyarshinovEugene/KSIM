...
Для цільової функції обрано показник екологічного стану міста — сумарне забруднення, яке генерується електростанціями і накопичується на патчах моделі.
Цей показник наявний у графіку стану середовища (World Status) моделі NetLogo:
![image1](image1.png)
та вказано у параметрі "**Measure**":
<pre>
(sum [ pollution ] of patches)
</pre>
Цей вираз повертає загальну кількість забруднення у середовищі на кожному такті симуляції.
Далі BehaviorSearch використовує його для побудови цільової функції.

![image1](image2.png)

**Налаштування цільової функції** (вкладка Search Objective)
Оскільки метою дослідження є покращення екологічного стану міста, у BehaviorSearch було встановлено:
Goal: Minimize fitness — мінімізувати загальне забруднення.
Collected measure: MEAN_ACROSS_STEPS — середнє значення забруднення за всі 500 тактів симуляції.
...
![Діалогове вікно запуску пошуку](image5.png)

Результат пошуку параметрів імітаційної моделі, використовуючи **генетичний алгоритм**:

![Результат генетичний алгоритм](image6.png)

Результат пошуку параметрів імітаційної моделі, використовуючи **випадковий пошук**:

![Результат випадковий пошук](image7.png)
